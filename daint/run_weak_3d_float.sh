...
do
    cd $cwd;
    mkdir runs/base_${BASE_N}_3d_float_multixmultiymultiz

    cp -r configs/3d/ runs/base_${BASE_N}_3d_float_multixmultiymultiz/
	...
	then
	    cd $cwd
	    cd runs/base_${BASE_N}_3d_float_multixmultiymultiz/3d/weak_scaling/kelvinhelmholtz_${N}/
	    x_cpus=$(($N/${BASE_N}))
